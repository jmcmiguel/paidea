<template>
    <div class="flex min-h-[33vh] bg-[#228ab7] bg-[url(/img/patterns2.png)] bg-cover bg-repeat pt-32 pb-16">
        <div class="flex flex-col mx-auto items-center justify-center">

            <h1 class="text-white text-center tracking-wide text-5xl font-extrabold">Try 1 hour class for <span class="text-[#ff8f00]"> FREE </span> </h1>
